...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_weight", type=str, default="sft_omni")
    ...
    parser.add_argument("--from_weight", type=str, default="pretrain_omni")
    parser.add_argument("--from_resume", type=int, default=0, choices=[0, 1])
    parser.add_argument("--freeze_llm", type=int, default=0, choices=[0, 1, 2])
    parser.add_argument("--use_compile", type=int, default=0, choices=[0, 1])
    parser.add_argument("--use_wandb", action="store_true")
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Omni-SFT")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb.init(project=args.wandb_project, name=f"MiniMind-Omni-SFT-{args.fusion_type}", id=wandb_id, resume=resume)
